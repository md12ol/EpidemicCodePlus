...
double** RRfuleA(int N, int M, const char* fn)
{//with allocation
...
void RRfuleNA(int N, int M, double** mt, const char* fn)
{//without allocation
...
void shuffleDX(int* dx, int N)
{//shuffle a sorting index
...
void smallfirst(double* fit, int* dx, int N)
{//special size two tournaments
...
int FPS(double* fit, double ttl, int n)
...
double uniform(double z)
{//uniform mutation of size z
...
//use methods
void dset::compute()
{//run the statistical computations
